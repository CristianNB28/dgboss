...
/*                  POST                 */
    postRiskDiverseForm: async (temparray) => {
        return new Promise((resolve, reject) => {
            db.query(`INSERT INTO Riesgo_Diverso (numero_certificado_riesgo_diverso, nom_razon_riesgo_diverso, cedula_riesgo_diverso, rif_riesgo_diverso, direccion_riesgo_diverso, telefono_riesgo_diverso, correo_riesgo_diverso, suma_asegurada_riesgo_diverso, modelo_riesgo_diverso, serial_riesgo_diverso, tipo_movimiento_riesgo_diverso)
                    VALUES ?`, 
            [temparray], 
            (error, rows) => {
                if (error) {
