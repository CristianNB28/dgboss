...
/*                  POST                 */
    postLetterGuaranteeForm: async (montoReclamoCartaAval, montoPagadoCartaAval, fechaOcurrenciaCartaAval, fechaNotificacionCartaAval, letterGuarantee) => {
        ...
        if (legalInsuredId[0] !== undefined) {
            return new Promise((resolve, reject) => {
                db.query(`INSERT INTO Carta_Aval (patologia_carta_aval, clinica_carta_aval, fecha_ocurrencia_carta_aval, fecha_notificacion_carta_aval, monto_reclamado_carta_aval, monto_pagado_carta_aval, observacion_carta_aval, tipo_moneda_carta_aval, estatus_carta_aval, numero_siniestro_carta_aval, asegurado_per_jur_id) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
                [letterGuarantee.patologia_carta_aval, letterGuarantee.clinica_carta_aval, fechaOcurrenciaCartaAval, fechaNotificacionCartaAval, montoReclamoCartaAval, montoPagadoCartaAval, letterGuarantee.observacion_carta_aval, letterGuarantee.tipo_moneda_carta_aval, letterGuarantee.estatus, letterGuarantee.numero_siniestro_carta_aval, legalInsuredId[0].id_asegurado_per_jur], 
                (error, rows) => {
                    if (error) {
                        reject(error);
                    }
            ...
            return new Promise((resolve, reject) => {
                db.query(`INSERT INTO Carta_Aval (patologia_carta_aval, clinica_carta_aval, fecha_ocurrencia_carta_aval, fecha_notificacion_carta_aval, monto_reclamado_carta_aval, monto_pagado_carta_aval, observacion_carta_aval, tipo_moneda_carta_aval, estatus_carta_aval, numero_siniestro_carta_aval, asegurado_per_nat_id) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
                [letterGuarantee.patologia_carta_aval, letterGuarantee.clinica_carta_aval, fechaOcurrenciaCartaAval, fechaNotificacionCartaAval, montoReclamoCartaAval, montoPagadoCartaAval, letterGuarantee.observacion_carta_aval, letterGuarantee.tipo_moneda_carta_aval, letterGuarantee.estatus, letterGuarantee.numero_siniestro_carta_aval, naturalInsuredId[0].id_asegurado_per_nat], 
                (error, rows) => {
                    if (error) {
                        reject(error);
                    }
        ...
        if (legalInsuredId[0] !== undefined) {
            ...
            return new Promise((resolve, reject) => {
                db.query(`UPDATE Carta_Aval 
                        SET patologia_carta_aval=?, clinica_carta_aval=?, fecha_ocurrencia_carta_aval=?, fecha_notificacion_carta_aval=?, monto_reclamado_carta_aval=?, monto_pagado_carta_aval=?, observacion_carta_aval=?, tipo_moneda_carta_aval=?, estatus_carta_aval=?, numero_siniestro_carta_aval=?, asegurado_per_nat_id=?, asegurado_per_jur_id=? 
                        WHERE id_carta_aval=?`, 
                [letterGuarantee.patologia_carta_aval, letterGuarantee.clinica_carta_aval, fechaOcurrenciaCartaAval, fechaNotificacionCartaAval, montoReclamoCartaAval, montoPagadoCartaAval, letterGuarantee.observacion_carta_aval, letterGuarantee.tipo_moneda_carta_aval, letterGuarantee.estatus, letterGuarantee.numero_siniestro_carta_aval, naturalInsuredId, legalInsuredId[0].id_asegurado_per_jur, letterGuarantee.id_carta_aval], 
                (error, rows) => {
                    if (error) {
                        reject(error);
                    }
            ...
            return new Promise((resolve, reject) => {
                db.query(`UPDATE Carta_Aval 
                        SET patologia_carta_aval=?, clinica_carta_aval=?, fecha_ocurrencia_carta_aval=?, fecha_notificacion_carta_aval=?, monto_reclamado_carta_aval=?, monto_pagado_carta_aval=?, observacion_carta_aval=?, tipo_moneda_carta_aval=?, estatus_carta_aval=?, numero_siniestro_carta_aval=?, asegurado_per_nat_id=?, asegurado_per_jur_id=? 
                        WHERE id_carta_aval=?`, 
                [letterGuarantee.patologia_carta_aval, letterGuarantee.clinica_carta_aval, fechaOcurrenciaCartaAval, fechaNotificacionCartaAval, montoReclamoCartaAval, montoPagadoCartaAval, letterGuarantee.observacion_carta_aval, letterGuarantee.tipo_moneda_carta_aval, letterGuarantee.estatus, letterGuarantee.numero_siniestro_carta_aval, naturalInsuredId[0].id_asegurado_per_nat, legalInsuredId, letterGuarantee.id_carta_aval], 
                (error, rows) => {
                    if (error) {
                        reject(error);
                    }
