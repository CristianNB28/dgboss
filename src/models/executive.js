...
/*                  POST                 */
    postExecutiveForm: (nombreEjecutivo, apellidoEjecutivo, montoPorcentajeEjecutivo, executive) => {
        return new Promise((resolve, reject) => {
            db.query(`INSERT INTO Ejecutivo (cedula_ejecutivo, tipo_cedula_ejecutivo, nombre_ejecutivo, apellido_ejecutivo, celular_ejecutivo, correo_ejecutivo, direccion_ejecutivo, cargo_ejecutivo, departamento_cargo_ejecutivo, porcentaje_ejecutivo)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
