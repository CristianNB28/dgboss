...
router.get('/premiums-pending', requireAuth, reportController.getPremiumsPending);
router.post('/premiums-pending', requireAuth, reportController.postPremiumsPending);
router.get('/commission-transits', requireAuth, reportController.getCommissionTransit);
router.post('/commission-transits', requireAuth, reportController.postCommissionTransit);
router.get('/commission-distribution', requireAuth, reportController.getCommissionDistribution);
router.post('/commission-distribution', requireAuth, reportController.postCommissionDistribution);
router.get('/commission-paid', requireAuth, reportController.getCommissionPaid);
